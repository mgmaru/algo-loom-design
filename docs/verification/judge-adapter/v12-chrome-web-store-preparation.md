...
> 確認日: 2026年9月20日
>
> 状態: `TD-37`と`TD-39`は完了し、`0.1.0`は2026年9月18日に限定公開まで実行した（[§8.1.3](#813-2026年9月18日の限定公開記録)）。現在は`TD-42`が進行中で、**修正版`0.1.1`が審査に合格した**（2026年9月20日に確認。[§8.1.7](#817-2026年9月20日の011審査通過記録)）。deferred publishingを選んでいるため合格だけでは公開されず、current versionは`0.1.0`のままである。**`0.1.1`の公開には別の明示承認が必要で、期限は2026年10月19日。** Distribution設定は料金なし・`Unlisted`・日本のみ。更新test用`0.1.2`は未upload。account名、実address、developer dashboard URLは記録していない
>
...
4. 審査通過後の`Unlisted`公開（`0.1.0`は2026年9月18日完了。**`0.1.1`は未実施。別の明示承認が必要**）
...
- **`0.1.1`の`Unlisted`公開。** 別の明示承認が必要で、期限は2026年10月19日（[§8.1.7](#817-2026年9月20日の011審査通過記録)）
- CWS配信済み`0.1.1`のbytes取得とsourceとの照合
- `TD-11`手順3での最終campaign manifest fileの生成（Chrome・OSの版が実行時に確定するため）
- `TD-11`の`V-12C`で使う`0.1.2`のupload・審査

この分離により、ローカル成果物を完了条件とする`TD-37`は完了です。**`TD-39`は2026年9月18日に完了条件をすべて満たしました**（[§8.1.4](#814-2026年9月18日の配信bytes取得記録)）。`TD-42`は手順1の審査結果の記録まで進み、手順2以降が公開の明示承認を待っています。`signed_builds`へ入れる値は`0.1.0`について固定済みですが、`0.1.1`の配信bytes取得、manifest fileの生成、`V-12A`〜`V-12E`の実行が残るため、`TD-11`と`V-12`は未完了です。
...
**修正版`0.1.1`は、段階2の#7〜#9と同じ手順を繰り返して合格まで到達しました**（[§8.1.6](#816-2026年9月19日の011審査提出記録)、[§8.1.7](#817-2026年9月20日の011審査通過記録)）。残るのは段階3の#10（公開。**別の明示承認が必要**）と#11（配信bytesの取得と照合）で、この2つが`TD-42`の手順2〜5にあたります。段階1に外部影響はありません。
